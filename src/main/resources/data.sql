...
-- 4. Create the 'employees' table with proper foreign key
...
('c3d4e5f6-a7b8-c9d0-e1f2-a3b4c5d6e7f8', 'Sam', 'Williams', 'sam.williams@example.com', '+15678901234', 'CONTRACT', 'b4d9c1a0-3e2b-4a5c-8f1d-6e9a2b4c8d7e', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('g7h8i9j0-k1l2-m3n4-o5p6-q7r8s9t0u1v2', 'Diana', 'Hall', 'diana.hall@example.com', '+19012345678', 'CONTRACT', 'c8a2b5e3-4f1a-4e8b-9d2c-1a3b5c7d9e2f', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('l2m3n4o5-p6q7-r8s9-t0u1-v2w3x4y5z6a7', 'Ivy', 'Taylor', 'ivy.taylor@example.com', '+14123456789', 'CONTRACT', 'b4d9c1a0-3e2b-4a5c-8f1d-6e9a2b4c8d7e', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
